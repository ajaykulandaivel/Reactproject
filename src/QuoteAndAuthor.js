  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: "white" }} className="quotebox">
        ...
        <button className='newquote' ><a  href={`https://twitter.com/compose/tweet?hashtags=quotes&text=${this.props.quote}`} target='_blank'><i class="fa-brands fa-twitter"></i></a></button>
